...
/**
 * A classe MenuMouseRotulo utiliza as classes do pacote awt para exibir um menu
 ...
 * classe MenuMouseRotulo é mostrado abaixo.
 *
 ...
 *<br>
 *&nbsp;public class MenuNovo extends MenuMouseRotulo<br>
 *&nbsp;{<br>
 *&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;public MenuMovo()<br>
 *&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>
 ...
 */
public class MenuMouseRotulo extends MenuMouse
{
	 ...
	 */
	public MenuMouseRotulo(AreaApplet origem) 
	{
		super(origem);
	 ...
	 *
	 * Nas subclasses de MenuMouseRotulo esse método deve ser sobrescrito para
	...
	private void criarMenuRotuloPadrao()
	{
		...
		String titulosMenus[] = new String[2];
		titulosMenus[0] = new String("Alterar texto");
		titulosMenus[1] = new String("Remover rótulo");
